...
2. Public v1 example bundle downloaded and extracted from [Onboarding](/guides/onboard), without a repository checkout
...
6. Refund walkthrough offline proofs and live fixture proofs passed without mismatch
