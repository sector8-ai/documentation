...
- Read published Mintlify docs and public GitHub example files at pinned tags  
...
2. Health endpoint reachable for their issued environment  
3. Verifier (or equivalent) printed ALLOW + DENY traces  
4. Both traces verified in Decision Feed (dashboard session)  
5. Refund walkthrough offline proofs passed **or** live fixture proofs passed without mismatch  
6. Enforce: zero dispatch on non-ALLOW; Observe: continued on DENY/failure  
