...
2. Example scripts downloaded at the **immutable SHAs** on [Onboarding](/guides/onboard) (not `main`)  
...
6. Refund walkthrough offline proofs passed **or** live fixture proofs passed without mismatch  
