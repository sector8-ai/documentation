...
If evaluation fails unexpectedly, treat the outcome as fail-closed: do not execute the proposed action. The gate may surface a context-bound `GUARD_INTERNAL_ERROR` deny with a decision artifact.
